...
namespace Kazetta.ViewModel
{
    ...
    public class MainWindow : ViewModelBase
    {
        ...
        public ICollectionView Fiuk => CollectionViewHelper.Lazy<Person>(Students, p => p.Sex == Sex.Male);
        public ICollectionView Lanyok => CollectionViewHelper.Lazy<Person>(Students, p => p.Sex == Sex.Female);
        public ICollectionView CsoportokbaOsztando => CollectionViewHelper.Lazy<Person>(Students, p => p.Type == PersonType.Student
