	...
	public class MainWindow : ViewModelBase
	{
		...
		public ObservableCollection2<Teacher> Teachers
		{
			get
			{
				if (teachers == null)
				{
					teachers = new ObservableCollection2<Teacher>(new Teacher[20]);
		...
		public ICollectionView GroupEligible => CollectionViewHelper.Lazy<Student>(Students, p => p.Pair == null && p.Instrument == Instrument.Solo);
		...
		{
			get => newGroup ?? (newGroup = new Group { Autogenerated = false, Persons = new Student[2] });
